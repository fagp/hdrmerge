...
class unetpad2(nn.Module):
    ...
    def __init__(self, n_classes=2, is_deconv=False, in_channels=3, is_batchnorm=False):
        ...
        self.up2 = unetUp(filters[3]+filters[2], filters[2], self.is_deconv)
        self.up1 = unetUp(filters[2]+filters[1], filters[1], self.is_deconv)
        self.up0 = unetUp2(filters[1], filters[0], self.is_deconv)
